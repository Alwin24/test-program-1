...
use test_program_1::CounterCompressedAccount;
...
async fn test() {
    ...
    let compressed_accounts = test_indexer.get_compressed_accounts_by_owner(&test_program_1::ID);
    ...
    R: RpcConnection + MerkleTreeExt,
{
    ...
    let instruction_data = test_program_1::instruction::Create {
        inputs: Vec::new(),
    ...
    let cpi_signer = find_cpi_signer(&test_program_1::ID);

    let accounts = test_program_1::accounts::Create {
        signer: payer.pubkey(),
        ...
        self_program: test_program_1::ID,
        cpi_signer,
    ...
    R: RpcConnection + MerkleTreeExt,
{
    ...
    let instruction_data = test_program_1::instruction::Increment {
        inputs,
        proof: rpc_result.proof,
        merkle_context,
    ...
    let accounts = test_program_1::accounts::Increment {
        signer: payer.pubkey(),
        light_system_program: PROGRAM_ID_LIGHT_SYSTEM,
        account_compression_program: PROGRAM_ID_ACCOUNT_COMPRESSION,
        account_compression_authority,
    ...
    R: RpcConnection + MerkleTreeExt,
{
    ...
    let instruction_data = test_program_1::instruction::Delete {
        inputs,
        proof: rpc_result.proof,
        merkle_context,
        merkle_tree_root_index: rpc_result.root_indices[0],
    ...
    let accounts = test_program_1::accounts::Delete {
        signer: payer.pubkey(),
        light_system_program: PROGRAM_ID_LIGHT_SYSTEM,
        account_compression_program: PROGRAM_ID_ACCOUNT_COMPRESSION,
        account_compression_authority,
